...
echo "Running test-time-training baseline..."
...
WRAP="bash /atlas/u/alekxos/domain_adaptation/mettta/ttt_cifar_release/script_baseline_meta.sh"

sbatch --output=$OUTPUT_PATH/ttt_baseline_%j.out --error=$ERROR_PATH/ttt_baseline_%j.err \
