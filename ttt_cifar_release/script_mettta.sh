...
#			--nepoch 50 --milestone_1 20 --milestone_2 40 \
#			--outf /atlas/u/alekxos/domain_adaptation/mettta/ttt_cifar_release/results_mettta/cifar10_layer2_bn_expand

CUDA_VISIBLE_DEVICES=0 python script_test_c10_mettta.py 5 layer2 online bn_expand
